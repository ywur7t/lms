...
from app.schemas.aggregate import all_buildings_schema, all_stat_schema
from app.models.aggregate import get_all_buildings, get_stat_by_year, get_stat_by_country, get_stat_by_type
